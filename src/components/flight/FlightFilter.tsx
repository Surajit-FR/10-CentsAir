...
const FlightFilter = (): JSX.Element => {
            ...
            <div className="col-md-4 col-lg-3">
                <div className="filter_text_1">
                    ...
                    <div className="step_1 filter_2 pb-2">
                        <h4 className="mb-2">Flight Slot Times</h4>
                        <ul className="morn_12">
                            <li>Morning 6 AM - 12</li>
                            <li>Noon 12 PM - 6</li>
                            <li>Evening 6 PM - 12</li>
                            <li>Night 12 AM - 6</li>
                        </ul>
                    </div>
