...
const RoundTripFlightResult = ({ recommendations }: { recommendations: Array<RecommendationsItemsType> }): JSX.Element => {
    const [pageNumber, setPageNumber] = useState<number>(0);
    const changePage = ({ selected }: { selected: number }) => {
        setPageNumber(selected);
    };

    const flightDummyData: Array<FlightData> = [
        {
            images: ["assets/images/show/1.png", "assets/images/show/2.png"],
            stops: [
            ...
            times: [
                { departure: { time: "11:45 AM", airport: "DAC" }, arrival: { time: "3:00 PM", airport: "YYC", nextDay: true } },
                { departure: { time: "6:20 PM", airport: "YYC" }, arrival: { time: "9:15 AM", airport: "DAC", plusDays: 2 } }
            ],
            price: "USD 1,937.99",
            paymentPlan: "$138/mo",
            additionalInfo: [
        ...
        {
            images: ["assets/images/show/3.png", "assets/images/show/4.png"],
            stops: [
                { airline: "Vistara", additional: "(with others)" },
                { airline: "Air Canada", additional: "(with others)" }
            ],
        ...
        {
            images: ["assets/images/show/5.png", "assets/images/show/6.png"],
            stops: [
                { airline: "Vistara", additional: "(with others)" },
                { airline: "Air Canada", additional: "(with others)" }
            ],
            ...
            <div className="col-md-4 col-lg-9">
                <div className="stoy_by_box">
                    ...
                    {flightDummyData?.map((flight, index) => (
                        <RoundTripFlightResultItem flight={flight} key={index} />
                    ))}
...
export default RoundTripFlightResult;