...
const ListedFlightSection = ({ flightsdata }: ListedFlightProps): JSX.Element => {
    ...
    return (
        <>{flightsdata && flightsdata?.AirItinerary?.OriginDestinationOptions.OriginDestinationOption.length > 0 &&(
            ...
            {flightsdata?.AirItinerary?.OriginDestinationOptions.OriginDestinationOption && flightsdata?.AirItinerary?.OriginDestinationOptions.OriginDestinationOption.length>0 && flightsdata?.AirItinerary?.OriginDestinationOptions.OriginDestinationOption.map((val, index) =>
